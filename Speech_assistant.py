...
import time
import threading
from schedule import every, run_pending  # For reminders; install with pip install schedule
...
WEATHER_API_KEY = 'your_openweather_api_key_here'  # Get from openweathermap.org
NEWS_API_KEY = 'your_newsapi_key_here'  # Get from newsapi.org

# Global list for reminders
reminders = []
